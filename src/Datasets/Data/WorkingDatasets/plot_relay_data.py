...
df_file_val = df_fld+"PhosRelay_DS_{}samples_{}obs_{}.pickle".format(nb_config_val, nb_obs_val, param_name)
...
df_file_train = df_fld+"PhosRelay_DS_{}samples_{}obs_{}.pickle".format(nb_config_train, nb_obs_train, param_name)
...
plt.legend()
plt.tight_layout()
fig.savefig(df_fld+"PhosRelay_Satisf_{}_w_valid.png".format(param_name))
plt.close()
