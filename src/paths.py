...
case_studies = [
    ...
    ["PrGeEx", "PrGeEx_DS_2500samples_50obs_k2k7", "PrGeEx_DS_400samples_1000obs_k2k7", ["k2","k7"], [r"$k7$", r"$k2$"]],
    ...
    # ["PRDeg", "PRDeg_DS_1000000_latin_samples_20obs_kprodk1k2k3k4kdeg", "PRDeg_DS_4096_latin_samples_1000obs_kprodk1k2k3k4kdeg", ["kp","k1","k2","k3","k4","kd"], [r"$k_p$",r"$k1$",r"$k2$",r"$k3$",r"$k4$",r"$k_d$"]],
]
