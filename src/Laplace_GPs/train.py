...
from Laplace_GPs.ep_utils import train_GP, evaluate_GP
from Laplace_GPs.expectation_propagation import EP
from Laplace_GPs.binomial_likelihood import Binomial
...
models_path = os.path.join("Laplace_GPs", models_path)
plots_path = os.path.join("Laplace_GPs", plots_path)
