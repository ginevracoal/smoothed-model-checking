...
parser.add_argument("--inference", default='expectation_propagation', type=str, help='Choose laplace or expectation_propagation')
...
plots_path = os.path.join("baselineGPs", plots_path)
