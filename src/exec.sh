...
SVI_GP_BATCH_SIZE=100 # 5000 if n_params=6
SVI_GP_N_EPOCHS=1000 # 100 if n_params=6
SVI_GP_LR=0.01

SVI_BNN_ARCHITECTURE="3L"
SVI_BNN_BATCH_SIZE=100 # 5000 if n_params=6
SVI_BNN_N_EPOCHS=10000 # 100 if n_params=6
SVI_BNN_LR=0.001
SVI_BNN_N_HIDDEN=30
