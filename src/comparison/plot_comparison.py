...
parser.add_argument("--svi_gp_variational_distribution", default='default', type=str, help="Variational distribution")
parser.add_argument("--svi_gp_variational_strategy", default='unwhitened', type=str, help="Variational strategy")
